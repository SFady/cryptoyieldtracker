...
function BotIcon({ active = true, positive = true }) {
  const accent = active ? (positive ? "#00e5a0" : "#c97070") : "#444466";
  ...
  return (
    <svg width="52" height="52" viewBox="0 0 52 52" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <circle cx="38" cy="14" r="3.5" fill={active ? (positive ? "#00e5a0" : "#c97070") : "#333355"} stroke={base} strokeWidth="1" />
    ...
    <>
      <div className="bots-header">
        ...
        <div className="bots-header-stat">
          ...
          {connected
            ...
            : <span className="bots-header-value" style={{ color: "#c97070" }}>
              <span className="pulse-dot" style={{ background: "#c97070" }} />
              RECONNECTING
            </span>
          }
        </div>
      ...
      <div className="bots-grid">
        {BOT_NAMES.map((name, i) => {
          ...
          const isPos = val >= 0;
          const disabled = i === 9;
          const accent = disabled ? "#555588" : isPos ? "#00e5a0" : "#c97070";
