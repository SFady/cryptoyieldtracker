...
export default function ProfilePage() {
  ...
  const [coeff2, setCoeff2] = useState(null);
            ...
            <div style={{ padding: "4px 0 2px 0", marginBottom: 10, display: "flex", gap: 6, alignItems: "center", flexWrap: "wrap" }}>
              ...
              {coeff2 !== null && (
                <span style={{
                  fontSize: "0.65rem", fontFamily: "monospace",
                  padding: "2px 8px", borderRadius: 4,
                  background: "rgba(200,200,220,0.08)", border: "1px solid rgba(200,200,220,0.25)", color: "#c8c8dc",
                }}>
                  Coeff : {coeff2}
                </span>
              )}
